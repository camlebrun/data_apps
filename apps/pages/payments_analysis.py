...
fig = px.pie(values=orders_status, names=orders_status.index, title='Orders Status')#px.bar(x=orders_status.index, y=orders_status, title='Orders Status', labels={'y': 'Percentage'})
st.plotly_chart(fig, use_container_width=True)
