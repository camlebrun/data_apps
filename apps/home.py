...
st.write("This dashboard provides insights into the performance of Olist's business operations. The dashboard is divided into four sections: **Revenues**, **Orders**, **Payments methods**, **sellers**, **Years overs Years**, and **Custumers segmentation**. You can navigate to each section using the sidebar on the left.")
